...
%%%%%%%%%%%%%%%%%WRITE NAMES AND PERSONAL IDENTITY NUMBERS WHERE SPECIFIED%%%%%%%%%%
  \fbox{\parbox{0.95\columnwidth}{
      \begin{tabular}{lp{9cm}}
        \rule{0mm}{6mm} Chang, Hongsheng\\
        \rule{0mm}{6mm} 951228-2451\\
        \rule{0mm}{6mm} Jiang, Sifan\\
        \rule{0mm}{6mm} 961220-8232\\
      \end{tabular}}}
...
\vspace{-0.7cm}
  ...
  \rule{5cm}{0mm}  && yes& no & \\
    ...
    \rule{5cm}{0mm}  && yes& no & \\
    Models of three differemt model structures have been estimated? && \minbox  & \minbox & \\
 ...
 \rule{5cm}{0mm}  && yes& no & \\
    ...
    \rule{5cm}{0mm}  && yes& no & \\
    A top 4 ranking of the estimated models have been made? && \minbox  & \minbox & \\


    \rule{5cm}{0mm}  && yes& no & \\
    The best and worst models have been compared using Bode plots, and analyze through pole/zeros and correlation(residuals) analysis using (compare) and correlation analysis(resid)?  && \minbox  & \minbox & \\
